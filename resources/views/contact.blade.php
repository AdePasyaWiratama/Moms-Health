        ...
        <div class="row tm-welcome-row">
            <div class="col-12 tm-page-cols-container">
                ...
                <div class="tm-page-col-right">
                    <div class="tm-welcome-parallax" data-parallax="scroll" data-image-src="img/kontak.jpg"></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 tm-page-cols-container">
                <div class="tm-page-col-left">
                    <div class="tm-contact-container tm-mb-6">
                        <div class="tm-address-container">
                            ...
                            <address>
                                <p>
                                   Jl. Andong 1 No.29<br />
                                    RT 5/7 Kota Bambu Selatan<br />
                ...
                <div class="tm-page-col-right tm-form-container">
                    <h2 class="tm-text-secondary mb-4">Contact Us</h2>
                        <p> Phone : 089527198980<br/>
                        Email : wiratamapasya@gmail.com<br/>
                        </p>
                    <form action="contact.html" method="POST" id="tm_contact_form" enctype="multipart/form-data">
                        ...
                        <div class="tm-mb-5">
                            <textarea rows="10" id="contact_message" name="contact_message"
                                class="form-control rounded-0" placeholder="Your Message" required=""></textarea>
                        </div>
